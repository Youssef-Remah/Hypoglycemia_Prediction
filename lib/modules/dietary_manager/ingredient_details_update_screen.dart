...
class IngredientDetailsUpdateScreen extends StatelessWidget {

  IngredientDetailsUpdateScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DietaryManagerCubit, DietaryManagerStates>(
      ...
      builder: (BuildContext context, DietaryManagerStates state)
      {
        ...
        cubit.getIngredientAmount(id: ingredientId);

        ingredientAmountController.text = cubit.ingredientAmount.toString();
