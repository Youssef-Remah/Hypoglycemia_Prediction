...
import 'package:hypoglycemia_prediction/modules/dietary_manager/ingredient_details_screen.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DietaryManagerCubit, DietaryManagerStates>(
      ...
      listener: (BuildContext context, DietaryManagerStates state)
      {
        ...
        {
          DietaryManagerCubit.get(context).addMealToDatabase(mealName: mealNameController.text);
        }

        if(state is DietaryManagerAddMealToDatabaseSuccessState)
        {
          showFlutterToast(
            context: context,
                  ...
                  child: Column(
                    ...
                    [
                      ...
                      Row(
                        ...
                        [
                          ConditionalBuilder(
                            condition: state is! DietaryManagerAddMealToDatabaseLoadingState &&
            ...
            IconButton(
              onPressed: ()
              {
                Navigator.push(
                  context,
                  MaterialPageRoute (
                    builder: (BuildContext context) => IngredientDetailsScreen(ingredientId: ingredient['id'],),
                  ),
                );
              },
